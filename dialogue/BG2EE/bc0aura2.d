...
Global("C0AuraAerieFriendship","LOCALS",0)~ THEN BAERIE C0AuraAerie1
~Oh. Oh my... whatever is that delicious scent?~ [C0BLANK]
DO ~IncrementGlobal("C0AuraAerieFriendship","LOCALS",1)~
...
!StateCheck("Aerie",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraAerieFriendship","GLOBAL",1)~ THEN BAERIE C0AuraAerie2
~Do you ever miss home, Aura?~ [C0BLANK]
DO ~IncrementGlobal("C0AuraAerieFriendship","LOCALS",1)~
...
== BC0AURA2 IF ~IsValidForPartyDialog("C0Aura") GlobalGT("C0AuraAerieFriendship","LOCALS",0)~ THEN ~Aerie! Oh, for goodness sake... I'll go after her, <CHARNAME>, just wait a moment.~
...
Global("C0AuraAnomen1","LOCALS",0)~ THEN BANOMEN C0AuraAnomen1
...
DO ~SetGlobal("C0AuraAnomen1","LOCALS",1)~
...
Global("AnomenIsNotKnight","GLOBAL",0)
Global("C0AuraAnomen1","LOCALS",1)~ THEN BC0AURA2 C0AuraAnomen2
~Anomen? Um, do you have a moment?~ [C0BLANK]
DO ~SetGlobal("C0AuraAnomen1","LOCALS",2)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
AreaType(FOREST)
Global("C0AuraCernd2","LOCALS",0)~ THEN BCERND C0AuraCernd2
...
DO ~SetGlobal("C0AuraCernd2","LOCALS",1)~
...
!StateCheck("Cernd",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraCernd2","LOCALS",1)~ THEN BCERND C0AuraCernd3
~Remember, do not open your eyes. Just keep calm and breathe. And listen.~ [C0BLANK]
DO ~SetGlobal("C0AuraCernd2","LOCALS",2)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraDorn1","LOCALS",0)~ THEN BC0AURA2 C0AuraDorn1
~Dorn, have you ever considered, um... being a little bit, I don't know... nicer?~ [C0BLANK]
DO ~SetGlobal("C0AuraDorn1","LOCALS",1)~
...
!StateCheck("Dorn",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraDorn2","LOCALS",0)~ THEN BDORN C0AuraDorn3
...
DO ~SetGlobal("C0AuraDorn2","LOCALS",1)~
...
Global("C0AuraDorn3","LOCALS",0)~ THEN BDORN C0AuraDorn4
~Why do you continue to stare at me, you meek little runt?~ [C0BLANK]
DO ~SetGlobal("C0AuraDorn3","LOCALS",1)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraEdwin1","LOCALS",0)
Global("C0AuraKnowsBG1","GLOBAL",1)~ THEN BEDWIN C0AuraEdwin1
...
DO ~SetGlobal("C0AuraEdwin1","LOCALS",1)~
...
== BC0AURA2 IF ~!Class(Myself,MAGE_ALL)~ THEN ~I think I might even be able to start casting spells myself soon! And then I'll surpass you, just you wait!~
== BC0AURA2 IF ~Class(Myself,MAGE_ALL)~ THEN ~I think I might even become a better mage than you one day!~
...
!StateCheck("HaerDalis",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraHaerDalis2","LOCALS",0)~ THEN BC0AURA2 C0AuraHaerDalis2
~I, um... did I mention I watched a few of the Sigil Troupe's plays, Haer'Dalis? I'm a huge fan.~ [C0BLANK]
DO ~SetGlobal("C0AuraHaerDalis2","LOCALS",1)~
...
!StateCheck("HaerDalis",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraHaerDalis3","LOCALS",0)~ THEN BC0AURA2 C0AuraHaerDalis3
~Hm-hm-hm-hmmm...~ [C0BLANK]
DO ~SetGlobal("C0AuraHaerDalis3","LOCALS",1)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraHexxat1","LOCALS",0)~ THEN BHEXXAT C0AuraHexxat1
~Aura.~ [C0BLANK]
DO ~SetGlobal("C0AuraHexxat1","LOCALS",1)~
== BC0AURA2 ~Y–yes?~
...
!StateCheck("Hexxat",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraHexxat1","LOCALS",1)~ THEN BHEXXAT C0AuraHexxat2
~May I ask you something, Aura?~ [C0BLANK]
DO ~SetGlobal("C0AuraHexxat1","LOCALS",2)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraImoen1","LOCALS",0)
Global("C0AuraKnowsBG1","GLOBAL",1)~ THEN BC0AURA2 C0AuraImoenBG1
~Heya, Imoen.~ [C0BLANK]
DO ~SetGlobal("C0AuraImoen1","LOCALS",1)~
...
Global("C0AuraImoenPCRom","LOCALS",0)~ THEN BIMOEN2 C0AuraImoenPCRom
~Sooo... you *like* my little sis, huh?~ [C0BLANK]
DO ~SetGlobal("C0AuraImoenPCRom","LOCALS",1)~
...
!StateCheck("Imoen2",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraImoenBombMaker","LOCALS",0)~ THEN BIMOEN2 C0AuraImoenBombMaker
~Hey, Aura? Could I ask you a favor?~ [C0BLANK]
DO ~SetGlobal("C0AuraImoenBombMaker","LOCALS",1)~
== BC0AURA2 ~Yep, shoot.~
...
!StateCheck("Imoen2",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraImoenBombMaker","LOCALS",1)~ THEN BC0AURA2 C0AuraImoenBombMaker2
...
DO ~SetGlobal("C0AuraImoenBombMaker","LOCALS",2)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraJaheiraBG1Talk1","LOCALS",0)~ THEN BJAHEIR C0AuraJaheiraBG1Talk1
...
DO ~SetGlobal("C0AuraJaheiraBG1Talk1","LOCALS",1)~
...
!StateCheck("Jaheira",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraJaheiraBG1Talk2","LOCALS",0)~ THEN BC0AURA2 C0AuraJaheiraBG1Talk2
~Jaheira? Do you have a moment?~ [C0BLANK]
DO ~SetGlobal("C0AuraJaheiraBG1Talk2","LOCALS",1)~
...
!StateCheck("Jaheira",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraJaheira1","LOCALS",0)~ THEN BJAHEIR C0AuraJaheira1
...
DO ~SetGlobal("C0AuraJaheira1","LOCALS",1)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraJan1","LOCALS",0)~ THEN BJAN C0AuraJan1
~~ [C0BLANK]
DO ~SetGlobal("C0AuraJan1","LOCALS",1)~
== BC0AURA2 ~~
EXIT
...
Global("C0AuraJanAirship","LOCALS",0)~ THEN BJAN C0AuraJanAirshipTalk
~See that flying machine, Aura? My cousin Eduardo designed and crafted it right here in Athkatla.~ [C0BLANK]
DO ~SetGlobal("C0AuraJanAirship","LOCALS",1)~
...
!StateCheck("Jan",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraJan1","LOCALS",2)~ THEN BC0AURA2 C0AuraJanFlasher
...
DO ~SetGlobal("C0AuraJan1","LOCALS",3)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraKeldorn1","LOCALS",0)~ THEN BKELDOR C0AuraKeldorn1
~Hold a moment, Aura. I believe this doll is yours, is it not?~ [C0BLANK]
DO ~SetGlobal("C0AuraKeldorn1","LOCALS",1)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraKorgan1","LOCALS",0)~ THEN BKORGAN C0AuraKorgan1
~I'll admit, I've found meself a mite impressed by ye, lass.~ [C0BLANK]
DO ~SetGlobal("C0AuraKorgan1","LOCALS",1)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraMazzy1","LOCALS",0)~ THEN BC0AURA2 C0AuraMazzy1
...
DO ~SetGlobal("C0AuraMazzy1","LOCALS",1)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
AreaType(FOREST)
Global("C0AuraMazzy2","LOCALS",0)~ THEN BMAZZY C0AuraMazzy2
...
DO ~SetGlobal("C0AuraMazzy2","LOCALS",1)~
...
DO ~ApplySpellRES("C0AUPROF","C0AUPROF")~ EXIT
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraMinsc1","LOCALS",0)~ THEN BMINSC C0AuraMinsc1
...
DO ~SetGlobal("C0AuraMinsc1","LOCALS",1)~
...
!StateCheck("Minsc",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraMinsc1","LOCALS",1)~ THEN BC0AURA2 C0AuraMinsc2
~Hey, Minsc. Think fast!~ [C0BLANK]
DO ~SetGlobal("C0AuraMinsc1","LOCALS",2)~
...
!StateCheck("Minsc",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraMinsc2","LOCALS",0)~ THEN BMINSC C0AuraMinsc3
~Ah–hay! Aura!~ [MINSC36]
DO ~SetGlobal("C0AuraMinsc2","LOCALS",1)~
...
!StateCheck("Minsc",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraMinscRestTalk1","LOCALS",0)~ THEN BMINSC C0AuraMinsc4
...
DO ~SetGlobal("C0AuraMinscRestTalk1","LOCALS",1)~
...
!StateCheck("Nalia",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraNalia1","LOCALS",0)~ THEN BNALIA C0AuraNalia2
...
== BNALIA ~I wish the world could be a place where your people could share their knowledge without fear of what that could mean. It's too bad it isn't. One day, perhaps, if we try to make a change.~
EXIT
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraNeera1","LOCALS",0)~ THEN BNEERA C0AuraNeera1
~Hey, Aura... does your squirrel bite?~ [C0BLANK]
DO ~SetGlobal("C0AuraNeera1","LOCALS",1)~
...
!StateCheck("Neera",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraNeera2","LOCALS",0)~ THEN BNEERA C0AuraNeera2
~Here. You can have your book back, Aura... ugh.~ [C0BLANK]
DO ~SetGlobal("C0AuraNeera2","LOCALS",1)~
== BC0AURA2 ~What? Didn't you borrow that from me just last night? You can't have finished it already!~
== BNEERA ~Nope, I couldn't even get through half of it. I feel like my head's about to implode. I can barely read any of this—how in the name of Mystra's soggy stockings can you actually memorize any of it?~
...
== BC0AURA2 ~I don't th—~
== BNEERA ~Facioooo... vocooo... ferre!~
== BNEERA ~Ta-da-da-daaa!~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraValygar1","LOCALS",0)~ THEN BVALYGA C0AuraValygar1
...
DO ~SetGlobal("C0AuraValygar1","LOCALS",1)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraViconia1","LOCALS",0)~ THEN BVICONI C0AuraViconia1
~Gah! Xza'iblith shu'jor!~ [C0BLANK]
DO ~SetGlobal("C0AuraViconia1","LOCALS",1)~
...
!StateCheck("Viconia",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraViconia2","LOCALS",0)~ THEN BC0AURA2 C0AuraViconia2
~Viconia, have you ever thought about wearing a hat?~ [C0BLANK]
DO ~SetGlobal("C0AuraViconia2","LOCALS",1)~
...
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraYoshimo1","LOCALS",0)~ THEN BYOSHIM C0AuraYoshimo1
...
DO ~IncrementGlobal("C0AuraYoshimo1","LOCALS",1)~
...
== BYOSHIM ~Hmm... another time, dear 'Ah-tan'. I fear if I begin to speak of home, it will be some time before I stop. And I doubt <CHARNAME> would appreciate that. Heh.~
EXIT
...
!StateCheck("Yoshimo",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraYoshimo2","LOCALS",0)~ THEN BYOSHIM C0AuraYoshimo2
~Your pleasant spirit is quite contagious, little A-tan. It is truly fortunate, to have your cheerful and considerate person to lighten the party's atmosphere.~ [C0BLANK]
DO ~IncrementGlobal("C0AuraYoshimo2","LOCALS",1)~
== BC0AURA2 ~'A-tan'? Are you going to call me that from now on, Yoshimo?~
