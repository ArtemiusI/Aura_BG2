...
CHAIN IF ~Global("C0AuraBG2FriendshipImportTalk","GLOBAL",2)~ THEN C0AURA2J FRIEND-BG1-1
~Oh, it's such a wonder to be travelling with you again, <CHARNAME>, and so soon! It's like we were never apart at all, isn't it?~
...
++ ~Can we talk later? I'm not exactly in the moon to reminisce right now, if you don't mind.~ + FRIEND-BG1-1-0

CHAIN C0AURA2J FRIEND-BG1-1-0
~Oh. Right... we'll have plenty of time in the future to catch up, won't we. Okay, that's all for now then!~
EXIT

CHAIN C0AURA2J FRIEND-BG1-1-1
...
CHAIN C0AURA2J FRIEND-BG1-1-9
~Thank you, <CHARNAME>. I'm really glad you're my friend.~
EXTERN C0AURA2J FRIEND-BG1-1-11

CHAIN C0AURA2J FRIEND-BG1-1-10
~Don't worry, <CHARNAME>. I'll do everything I can for you.~
EXTERN C0AURA2J FRIEND-BG1-1-11

CHAIN C0AURA2J FRIEND-BG1-1-11
...
CHAIN C0AURA2J FRIEND-BG1-1-12
...
CHAIN IF ~Global("C0AuraBG2FriendshipImportTalk","GLOBAL",4)~ THEN C0AURA2J FRIEND-BG1-2
...
CHAIN IF WEIGHT #-1 ~Global("C0AuraIllithium","GLOBAL",1)~ THEN C0AURA2J illithium
~Umm, <CHARNAME>? I just thought you might want to know that, er, probably won't work. The alloy, I mean.~
DO ~SetGlobal("C0AuraIllithium","GLOBAL",2)~
END
++ ~What do you mean by that?~ + illithium.1
++ ~Whether it works or not, it's our best choice.~ + illithium.1
++ ~Did I ask your opinion?~ + illithium.0

CHAIN C0AURA2J illithium.0
~Pff, well, okay then. Never mind I said anything. I won't say I told you so when Sir Sarles notices.~
DO ~SetGlobal("C0AuraIllithium","GLOBAL",-1)~ EXIT

CHAIN C0AURA2J illithium.1
~I've worked with illithium before. Not a lot of it, but I know its properties. It repels all sorts of grime and never tarnishes. This stuff's already got dirt and fingerprints all over it.~
END
++ ~Do you think Sarles will know the difference?~ + illithium.2
++ ~Can anything be done about it?~ + illithium.3

CHAIN C0AURA2J illithium.2
~I'd guess the reason he wants illithium is because of its qualities, so probably. I just can't imagine him going off to fight vampires with it, you know?~
EXTERN C0AURA2J illithium.3

CHAIN C0AURA2J illithium.3
~There's, well... some oils and chemical processes I have that can act as a repellent for grime for metals. It'd probably at least last long enough to finish sculpting it. It's not very honest, but... it's just a option, at least.~
END
++ ~I'd rather not be deceitful. We should just tell the truth.~ + illithium.4
++ ~Okay, take the alloy and work with it.~ + illithium.5

CHAIN C0AURA2J illithium.4
~Oh. Okay, that's... that's probably for the best. Hopefully the artist won't be too mad.~
DO ~SetGlobal("C0AuraIllithium","GLOBAL",-1)~ EXIT

CHAIN C0AURA2J illithium.5
~Alright... it won't take long at all with an alloy of this size. The product should be basically indistinguishable from pure illithium.~
DO ~SetGlobal("C0AuraIllithium","GLOBAL",3)~ EXIT

EXTEND_BOTTOM SCSARLES 22
IF ~Global("C0AuraIllithium","GLOBAL",3)~ DO ~TakePartyItem("MISC6S")~ EXTERN SCSARLES 15
END
...
END
++ ~What is it?~ DO ~TakePartyItem("misc5g") DestroyItem("misc5g")~ + AURA-ELEPHANT-HIDE-1
...
AddJournalEntry(%Aura_Quest1_1%,QUEST)~  EXIT
...
== YOSHIMOX ~Au-tan, please... don't. I cannot afford to stay my hand. I have tarried too long already.~
...
== YOSHIMOX ~...~
== YOSHIMOX ~You are far too naive, Au-tan. Do you believe Irenicus would have chosen any fool to gain <CHARNAME>'s trust? Every action I made to said, every action I made while in your company was to lead to this ending. Befriending you, naturally, was just another means to an end.~
...
== C0AURA2J IF ~InParty("C0Aura") See("C0Aura") Range("C0Aura",15) !StateCheck("C0Aura",CD_STATE_NOTVALID)~ THEN ~Th–that was the most terrifying thing I've ever seen in my life! I– I've seen that monster before, <CHARNAME>! It was the Slayer, the avatar of Bhaal!~
...
== C0AURA2J ~I'm not afraid of you. Not while I have <CHARNAME> with me.~
...
CHAIN IF WEIGHT #-1
~Global("C0AuraVampire","GLOBAL",3)~ THEN BODHIAMB C0AuraBodhiKidnap
~What is this?!~
== C0AURA2J ~** WE AWAKEN AND PROTECT, AS WILLED BY THE SUCCESSOR OF AMANOKAGAMI... BEGONE, CREATURE OF DARKNESS! **~
== BODHIAMB ~Accursed foreign magicks! I will ensure that you suffer eternally for this, gnome. Follow if you dare!~
COPY_TRANS BODHIAMB 7
...
IF ~InParty("C0Aura") InMyArea("C0Aura") !StateCheck("C0Aura",CD_STATE_NOTVALID) Global("C0AuraBeholder","GLOBAL",0)~ EXTERN C0AURA2J C0AuraSAHBEH34
END

CHAIN C0AURA2J C0AuraSAHBEH34
~But, what if, let's say, *you* opened it, and I was just very very careful and didn't touch the chest at all to get what's inside... would you allow that? Um, in theory, of course.~
== SAHBEH01 ~Hrmmm. Huh...~
EXTERN SAHBEH01 35
...
~Anyways, I know someone who works in this district. His name's Cromwell, and he's an excellent smith. I haven't known him long, but everything I've seen him build is exquisite.~
END
...
== WSMITH01 ~Ah, if it ain't the clever lass with the magnificent construct. It's good to see ye again. And these folk be...?~
== C0AURA2J IF ~!IsGabber(Player1)
!IsGabber("C0Aura")~ ~This is <GABBER>, one of my companions. We're here to make use of your masterful skills.~
== C0AURA2J IF ~OR(2)
IsGabber("C0Aura")
IsGabber(Player1)~ ~This is <CHARNAME>, my leader. We're here to make use of your masterful skills.~
END
IF ~!IsGabber("C0Aura")~ EXTERN WSMITH01 5
IF ~IsGabber("C0Aura")~ DO ~SetGabber(Player1)~ EXTERN WSMITH01 5
...
I_C_T C6REGIS1 2 C0AuraDrizzt1
== C0AURA2J IF ~InParty("C0Aura") InMyArea("C0Aura") !StateCheck("C0Aura",CD_STATE_NOTVALID)~ THEN ~*gasp* Oh my goodness, it's Drizzt Do'Urden!~
END
...
I_C_T C6DRIZZ1 37 C0AuraDrizzt3
== C0AURA2J IF ~InParty("C0Aura") InMyArea("C0Aura") !StateCheck("C0Aura",CD_STATE_NOTVALID)~ THEN ~Ohh, we're really going to be fighting alongside the Companions of the Hall! My sisters are going to be so jealous when I tell them...~
END
...
== C0AURA2J IF ~InParty("C0Aura") InMyArea("C0Aura") !StateCheck("C0Aura",CD_STATE_NOTVALID)~ THEN ~T–t–TWO HUNDRED POUNDS?! <CHARNAME>, do you have any idea how unlikely it is just getting enough illithium to fit in the palm of your hand?~
END
...
== C0AURA2J IF ~InParty("C0Aura") InMyArea("C0Aura") !StateCheck("C0Aura",CD_STATE_NOTVALID)~ THEN ~After everything you've done... even I can't afford to show you any mercy, Irenicus. A place like this is just what you deserve!~
END
...
CHAIN IF WEIGHT #-1 ~InParty("C0Aura") InMyArea("C0Aura") !StateCheck("C0Aura",CD_STATE_NOTVALID) Global("C0AuraMaJansen","LOCALS",0)~ THEN MAJAN majansen
...
ADD_TRANS_TRIGGER MADAM 0 ~!Name("C0Aura",LastTalkedToBy)~ DO 0 1 4

ADD_TRANS_TRIGGER MADAM 7 ~!Name("C0Aura",LastTalkedToBy)~ DO 0 3
...
== C0AURA2J ~Umm... I dunno, it's tempting, but... what am I supposed to do with a giant metal ball? Does it do anything?~
== WAYLANE ~It, uh... does all sorts of things. Just pay five— nay, *four* hundred gold pieces, and find out for yourself!~
== C0AURA2J ~Thanks, but I'll pass. It's a little too big to carry around with me. Good, uh... luck with your sale, I guess?~
EXIT

CHAIN IF WEIGHT #-1
~!InPartySlot(LastTalkedToBy,0)
Name("C0Aura",LastTalkedToBy)~ THEN SALVANAS AURA-SALVANAS
...
~I'm not familiar with the dialect... but they want to know our intent, I think. Let's show them we mean no harm.~
EXTERN UDSVIR01 0
...
ADD_TRANS_TRIGGER KGENIE1 3 ~!InParty("C0Aura") InMyArea("C0Aura") !StateCheck("C0Aura",CD_STATE_NOTVALID)~ DO 0 1 2 3 4 5
...
== WILSON ~Growl...~
DO ~ActionOverride("C0Aura",RunAwayFrom("WILSON",2))~ EXIT
