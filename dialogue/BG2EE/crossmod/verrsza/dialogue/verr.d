...
!StateCheck("L#2VERR",CD_STATE_NOTVALID)
!StateCheck("C0Aura",CD_STATE_NOTVALID)
Global("C0AuraL#2Verr3","GLOBAL",0)~ THEN L#2VERRB C0AuraVerr3
~No.~ [C0BLANK]
DO ~SetGlobal("C0AuraL#2Verr3","GLOBAL",1)~
== BC0AURA2 ~But it's—~
== L#2VERRB ~I said no!~
== BC0AURA2 ~Oh, come on! It'll make your fur nice and silky! You've needed grooming for ages.~
== L#2VERRB ~I am not a housecat, you ridiculous creature! I do not need my fur brushed!~
== BC0AURA2 ~You'll like it! Don't tell me you enjoy having loose hairs and dust on that mangy coat?~
== L#2VERRB ~My coat is not mangy!~
== BC0AURA2 ~It's not that bad, I promise! At most, it'll tickle you.~
== BC0AURA2 IF ~IsValidForPartyDialog("L#2PHAL")~ THEN ~Phalh liked being brushed so much, he was basically purring!~
== L#2PHALB IF ~IsValidForPartyDialog("L#2PHAL")~ THEN ~I was doing nothing of the sort!~
== L#2VERRB ~I don't know if you're delusional or just suicidal, but do not treat me like your pet. My patience for you is thin enough as it is. Now go away!~
== BC0AURA2 ~Fine. Then I'll do it when you're asleep.~
== L#2VERRB ~Don't you dare. I've practiced sleeping with one eye open. You come anywhere close to me with that, you'll breathe just long enough to regret it.~
== BC0AURA2 ~*pout* Bluuuueeh. You mean cat.~
EXIT
...
== L#2PHALB ~With Uncle Verr, who doesn't know any magic, being of no help on that end? Yep, it was hard work alright.~
